class Api::V1::MessagesController::Update < ActiveInteraction::Base
  ...
  def execute
    ...
    sender = compose(self.class.parent::Get::User, mkey: sender_mkey, relation: :sender)
    connection = compose(self.class.parent::Get::Connection, user_1: user, user_2: sender)
